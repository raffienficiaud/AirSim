...
class Vector2r(MsgpackMixin):
    ...
    attribute_order = [("x_val", float), ("y_val", float)]
...
class Vector3r(MsgpackMixin):
    ...
    attribute_order = [("x_val", float), ("y_val", float), ("z_val", float)]
...
class Pose(MsgpackMixin):
    ...
    attribute_order = [("position", Vector3r), ("orientation", Quaternionr)]
...
class GeoPoint(MsgpackMixin):
    ...
    attribute_order = [("latitude", float), ("longitude", float), ("altitude", float)]
...
class YawMode(MsgpackMixin):
    ...
    attribute_order = [("is_rate", bool), ("yaw_or_rate", float)]
...
class RotorStates(MsgpackMixin):
    ...
    attribute_order = [("timestamp", np.uint64), ("rotors", list)]


class ProjectionMatrix(MsgpackMixin):
    matrix = []
    attribute_order = [("matrix", list)]
...
class Box2D(MsgpackMixin):
    ...
    attribute_order = [("min", Vector2r), ("max", Vector2r)]
...
class Box3D(MsgpackMixin):
    ...
    attribute_order = [("min", Vector3r), ("max", Vector3r)]
